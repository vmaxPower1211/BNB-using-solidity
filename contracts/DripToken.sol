...
contract MintableToken is StandardToken, Whitelist {
     ...
     */
    function finishMinting() onlyWhitelisted canMint virtual  public returns (bool) {
...
contract DripToken is MintableToken {
     ...
     */
    constructor(uint256 _initialMint) Ownable()  {
     ...
     */
    function finishMinting() onlyOwner canMint override view public returns (bool) {
        return false;
    }
    ...
    /** @dev Transfers */
    function transfer(address _to, uint256 _value) override(BEP20Basic, BasicToken)  public returns (bool) {
